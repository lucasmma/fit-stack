...
import { PhotosGallery } from "@/components/features/photos/PhotosGallery";
import { UploadPhotoButton } from "@/components/features/photos/UploadPhotoButton";

export const metadata = { title: "Photos — fit-stack" };
